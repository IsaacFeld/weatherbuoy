...
console.log({ "/api/data Response": dataResponse })
console.log({"/api/filter-value Response": filterValueResponse})

if (dataResponse.ok && filterValueResponse.ok) {
  

  const filterValueJson = await filterValueResponse.json()
  const dataJson = await dataResponse.json()

  console.log({ "Filter Value JSON": filterValueJson })
  console.log({ "Data Value JSON": dataJson })
  ...
  /* ERROR HANDLING */
  document.querySelector("#chartErrorMessage").classList.remove("hidden")
  
  
  
  document.querySelector("#mobileChartNav").classList.add("hidden")
  document.querySelector("#mobileChartNav").classList.remove("sm:hidden")
  document.querySelector("#desktopChartNav").classList.remove("sm:flex")
}